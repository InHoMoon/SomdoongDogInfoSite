...
import somdoong.member.controller.SomDoongMemberController;
...
public class AdminLoginController {
	...
	private static final Logger logger= 
			LoggerFactory.getLogger(SomDoongMemberController.class);  //로깅을 위한 변수
	...
	public ModelAndView admin_member_forced_eviction(String user_id) throws Exception {
		...
		SomDoongMember dto = new SomDoongMember();
