...
public class Paging_s {
	...
	public Paging_s(int totalCount, int curPage) {
	...
	public Paging_s(int totalCount) {
		setTotalCount(totalCount);
		
		makePaging();
	}
	
	public Paging_s(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public Paging_s(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);	//화면에 보여질 게시글 개수 지정하기
	...
	//-------
	public Paging_s(int totalCount, int curPage, String searchType, String keyword) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public Paging_s(int curPage, int totalCount, int listCount, int totalPage, int pageCount, int startPage, int endPage,
