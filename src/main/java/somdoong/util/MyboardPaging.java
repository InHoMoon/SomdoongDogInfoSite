...
public class MyboardPaging {
	...
	public MyboardPaging() {}
	
	
	public MyboardPaging(int totalCount, int curPage) {
	...
	public MyboardPaging(int totalCount) {
		setTotalCount(totalCount);
		
		makePaging();
	}
	
	public MyboardPaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public MyboardPaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);	//화면에 보여질 게시글 개수 지정하기
	...
	//-------
	public MyboardPaging(int totalCount, int curPage, String searchType, String keyword) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public MyboardPaging(int curPage, int totalCount, int listCount, int totalPage, int pageCount, int startPage, int endPage,
