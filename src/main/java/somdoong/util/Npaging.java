...
public class Npaging {
	...
	public Npaging(int totalCount, int curPage) {
	...
	public Npaging(int totalCount) {
		setTotalCount(totalCount);
		
		makePaging();
	}
	
	public Npaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public Npaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);	//화면에 보여질 게시글 개수 지정하기
	...
	public String toString() {
		return "Npaging [curPage=" + curPage + ", totalCount=" + totalCount + ", listCount=" + listCount
