...
public class AdminPaging {
	...
	//-------
	public AdminPaging(int totalCount, int curPage, String searchType, String keyword) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public AdminPaging(int curPage, int totalCount, int listCount, int totalPage, int pageCount, int startPage, int endPage,
