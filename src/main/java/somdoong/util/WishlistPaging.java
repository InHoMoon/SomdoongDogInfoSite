...
public class WishlistPaging {
	...
	public WishlistPaging(int totalCount, int curPage) {
	...
	public WishlistPaging(int totalCount) {
		setTotalCount(totalCount);
		
		makePaging();
	}
	
	public WishlistPaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public WishlistPaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);	//화면에 보여질 게시글 개수 지정하기
	...
	//-------
	public WishlistPaging(int totalCount, int curPage, String searchType, String keyword) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public WishlistPaging(int curPage, int totalCount, int listCount, int totalPage, int pageCount, int startPage,
			int endPage, int startNo, int endNo, String searchType, String keyword, String iUserid, String mUserid,
			int storeNo) {
		super();
	...
	public String toString() {
		return "WishlistPaging [curPage=" + curPage + ", totalCount=" + totalCount + ", listCount=" + listCount
				...
				+ keyword + ", iUserid=" + iUserid + ", mUserid=" + mUserid + ", storeNo=" + storeNo + "]";
	}
