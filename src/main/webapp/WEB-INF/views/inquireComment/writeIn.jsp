...
$(document).ready(function() {
	...
	//댓글등록
	$("#incommBtn").click(function(){
		
		//변수 선언
		var bno = ${fboard.fno};
		var commContent = $("#incommContent").val().replace("\n", "<br>");
		...
		$.ajax({
			url : "/inquireComment/writeIn"
			, type : "POST"
			, data : { "inum" : inum, "incommContent" : incommContent }
			, dataType : "text"
...
function inCount(){
	$.ajax({
		url : "/inquireComment/inCount?inum=${inquire.inum}"
		, type : "get"
...
//     $.ajax({
//         type: "get",
//         url: "/inquireComment/list?bno=${fboard.fno}&curPage="+num,
